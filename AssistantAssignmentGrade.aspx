<%@ Page Title="" Language="C#" MasterPageFile="~/AssisstantMaster.Master" AutoEventWireup="true" CodeBehind="AssistantAssignmentGrade.aspx.cs" Inherits="Regestration.AssistantAssignmentGrade" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style8">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Project.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [AssignmentAssistantGrade] WHERE [StudentUserName] = @StudentUserName" InsertCommand="INSERT INTO [AssignmentAssistantGrade] ([StudentUserName], [Grade], [CourseCode]) VALUES (@StudentUserName, @Grade, @CourseCode)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [StudentUserName], [Grade], [CourseCode] FROM [AssignmentAssistantGrade] WHERE ([CourseCode] = @CourseCode)" UpdateCommand="UPDATE [AssignmentAssistantGrade] SET [Grade] = @Grade, [CourseCode] = @CourseCode WHERE [StudentUserName] = @StudentUserName">
                    <DeleteParameters>
